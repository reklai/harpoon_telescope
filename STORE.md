...
**Pin your key tabs**
Anchor up to 6 tabs to numbered slots. Jump to any of them instantly with a keyboard shortcut. Your scroll position is saved and restored automatically, so you land exactly where you left off. If a pinned tab gets closed, it reopens in place when you jump to it.
...
Press Alt+Y to see your most-used tabs ranked by how often and how recently you visit them. Type to filter the list by title or URL. Jump to any tab with Enter.
